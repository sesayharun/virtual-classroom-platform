...
CREATE TABLE IF NOT EXISTS materials (
  ...
  resource_type ENUM('document', 'video', 'presentation', 'link') NOT NULL DEFAULT 'link',
...
CREATE TABLE IF NOT EXISTS discussions (
 id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,class_id BIGINT UNSIGNED NOT NULL,user_id BIGINT UNSIGNED NOT NULL,
 title VARCHAR(200) NOT NULL,content TEXT NOT NULL,created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS discussion_replies (
 id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,discussion_id BIGINT UNSIGNED NOT NULL,user_id BIGINT UNSIGNED NOT NULL,
